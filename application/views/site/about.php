...
<section class="first cover dark history" data-top="background-position: 50% -125px" data-top-bottom="background-position: 50% -225px">
    <div class="shade">
        <div class="content">
            <div class="gutter fade-anchor">
...
<section class="light-grey officers">
    <div class="content">
        <div class="gutter">
            <h2>Club Officers</h2>
            <div class="pad-text">
            ...
            <div class="board">
                <div class="officer">
                    <h3>President</h3>
                    <p>
                        <a href="mailto:president@richmondlions.com">Ben Morgan</a>
                        <br />
                        president@richmondlions.com
                    </p>
                </div>
                <div class="officer">
