...
<section class="first cover dark history fixed" data-top="background-position: 50% 0px" data-top-bottom="background-position: 50% 150px">
    <div class="shade">
        <div class="content">
            <div class="gutter">
...
<section class="light light-grey officers">
    <div class="content">
        <div class="gutter">
            <h2>Club Officers</h2>
            <div class="pad-text">
